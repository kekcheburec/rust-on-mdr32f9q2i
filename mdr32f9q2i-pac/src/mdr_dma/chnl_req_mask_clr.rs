...
pub struct R(crate::R<CHNL_REQ_MASK_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHNL_REQ_MASK_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHNL_REQ_MASK_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHNL_REQ_MASK_CLR_SPEC>) -> Self {
        R(reader)
    }
}
...
impl crate::Readable for CHNL_REQ_MASK_CLR_SPEC {
    type Reader = R;
}
