...
#[doc = "Register `RXDATAH` writer"]
pub struct W(crate::W<RXDATAH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXDATAH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXDATAH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXDATAH_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [rxdatah::W](W) writer structure"]
impl crate::Writable for RXDATAH_SPEC {
    type Writer = W;
}
