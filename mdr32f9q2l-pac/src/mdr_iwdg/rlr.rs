...
#[doc = "Field `RLR` reader - "]
pub struct RLR_R(crate::FieldReader<u16, u16>);
impl RLR_R {
    pub(crate) fn new(bits: u16) -> Self {
        RLR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RLR_R {
...
impl R {
    #[doc = "Bits 0:11"]
    #[inline(always)]
    pub fn rlr(&self) -> RLR_R {
        RLR_R::new((self.bits & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11"]
    #[inline(always)]
    pub fn rlr(&mut self) -> RLR_W {
        RLR_W { w: self }
    }
...
#[doc = "`reset()` method sets RLR to value 0"]
