...
pub struct RTC_DIV_R(crate::FieldReader<u32, u32>);
impl RTC_DIV_R {
    pub(crate) fn new(bits: u32) -> Self {
        RTC_DIV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RTC_DIV_R {
...
impl R {
    ...
    pub fn rtc_div(&self) -> RTC_DIV_R {
        RTC_DIV_R::new((self.bits & 0x000f_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:19"]
    #[inline(always)]
    pub fn rtc_div(&mut self) -> RTC_DIV_W {
        RTC_DIV_W { w: self }
    }
