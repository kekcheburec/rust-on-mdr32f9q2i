...
pub struct R(crate::R<DATAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATAL` writer"]
pub struct W(crate::W<DATAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATAL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CAN Transmit Data low Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [datal](index.html) module"]
pub struct DATAL_SPEC;
impl crate::RegisterSpec for DATAL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [datal::R](R) reader structure"]
impl crate::Readable for DATAL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [datal::W](W) writer structure"]
impl crate::Writable for DATAL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DATAL to value 0"]
impl crate::Resettable for DATAL_SPEC {
    #[inline(always)]
