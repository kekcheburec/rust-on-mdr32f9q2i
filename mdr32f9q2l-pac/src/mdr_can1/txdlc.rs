#[doc = "Register `TXDLC` reader"]
pub struct R(crate::R<TXDLC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXDLC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXDLC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXDLC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXDLC` writer"]
pub struct W(crate::W<TXDLC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXDLC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXDLC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXDLC_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "CAN Transmit DLC Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [txdlc](index.html) module"]
pub struct TXDLC_SPEC;
impl crate::RegisterSpec for TXDLC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [txdlc::R](R) reader structure"]
impl crate::Readable for TXDLC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [txdlc::W](W) writer structure"]
impl crate::Writable for TXDLC_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TXDLC to value 0"]
impl crate::Resettable for TXDLC_SPEC {
    #[inline(always)]
