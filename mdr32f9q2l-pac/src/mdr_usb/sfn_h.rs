...
pub struct FRAMENUM_R(crate::FieldReader<u8, u8>);
impl FRAMENUM_R {
    pub(crate) fn new(bits: u8) -> Self {
        FRAMENUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FRAMENUM_R {
...
impl R {
    ...
    pub fn framenum(&self) -> FRAMENUM_R {
        FRAMENUM_R::new((self.bits & 0x07) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2"]
    #[inline(always)]
    pub fn framenum(&mut self) -> FRAMENUM_W {
        FRAMENUM_W { w: self }
    }
