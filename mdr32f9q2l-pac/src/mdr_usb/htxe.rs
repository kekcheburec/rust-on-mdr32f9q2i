...
pub struct EPADDR_R(crate::FieldReader<u8, u8>);
impl EPADDR_R {
    pub(crate) fn new(bits: u8) -> Self {
        EPADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EPADDR_R {
...
impl W {
    #[doc = "Bits 0:3"]
    #[inline(always)]
    pub fn epaddr(&mut self) -> EPADDR_W {
        EPADDR_W { w: self }
    }
